...
<div class="ajax">
    ...
    <div class="" id="ajaxWrapper">
        ...
        <div class="ajax__container row js--ajaxContainer">
            <div class="col-sm-4">
        ...
        <a href="/ajaxAction.php?page=2" class="js--ajaxBtn btn btn-primary" data-for="ajaxWrapper">
            Показать еще
        </a>
    ...
    <a href="/ajaxAction.php" class="js--ajaxBtn btn btn-primary" data-for="ajaxWrapper">
        Показать еще вне контэйнера
    </a>
</div>
